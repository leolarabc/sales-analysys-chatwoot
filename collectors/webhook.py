...
Substitui o workflow n8n "FiestaHub - ConversaScore Captura".
...
app = FastAPI(title="FiestaHub Webhook", docs_url=None, redoc_url=None)
...
@app.get("/")
def health():
    return {"status": "ok", "service": "fiestahub-webhook"}
